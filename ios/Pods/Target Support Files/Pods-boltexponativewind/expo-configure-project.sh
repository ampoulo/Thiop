...
with_node \
  ...
  --target "/Users/amadoucheikhly/Thiop/ios/Pods/Target Support Files/Pods-boltexponativewind/ExpoModulesProvider.swift" \
  --entitlement "/Users/amadoucheikhly/Thiop/ios/boltexponativewind/boltexponativewind.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
